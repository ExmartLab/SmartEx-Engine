...
public class ExplanationContextMappingService {
	...
	public View getExplanationView(Context context, Object cause) {
		...
		if (cause instanceof Rule) {
			...
			String ruleBookRules = "exengine.contextexplanationgenerator.rulebookforrules";
			...
			String ruleBookErrors = "exengine.contextexplanationgenerator.rulebookforerrors";
